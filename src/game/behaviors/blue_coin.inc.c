...
void bhv_hidden_blue_coin_loop(void) {
    ...
    switch (o->oAction) {
        ...
        case HIDDEN_BLUE_COIN_ACT_ACTIVE:
            ...
            // After 400 frames of waiting and 40 2-frame blinks (for 480 frames total),
            // delete the object.
            if (cur_obj_wait_then_blink(400, 40)) {
...
void bhv_blue_coin_switch_loop(void) {
    ...
    switch (o->oAction) {
        ...
        case BLUE_COIN_SWITCH_ACT_EXTENDING:
            ...
            if ((cur_obj_nearest_object_with_behavior(bhvHiddenBlueCoin) == NULL) || (o->oTimer > 480)) {
                obj_mark_for_deletion(o);
            }
#endif
            break;
