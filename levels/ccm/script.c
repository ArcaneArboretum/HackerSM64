...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_NONE, -7628, 1921, 8384, 0, -180, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, -7628, 1921, 6451, 0, 0, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, -7854, 2789, 6639, 0, 90, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, -7647, 3089, 8389, 0, -180, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, -6869, 3605, 8389, 0, -180, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, -5863, 2179, 8196, 0, -90, 0, 0x00000000, bhvFlamethrower),
		OBJECT(MODEL_NONE, -6080, 2489, 6415, 0, 0, 0, 0x00000000, bhvFlamethrower),
