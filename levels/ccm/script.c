...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_1UP, -7778, 4961, 6925, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_1UP, -7778, 4961, 6662, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_1UP, -7778, 4961, 7217, 0, 0, 0, 0x00000000, bhv1Up),
		...
		OBJECT(MODEL_SPINDRIFT, -4023, 5890, 4392, 0, 0, 0, 0x00000000, bhvSpindrift),
		OBJECT(MODEL_SPINDRIFT, -5108, 6070, 5808, 0, 0, 0, 0x00000000, bhvSpindrift),
		...
		OBJECT(MODEL_NONE, -7770, 5106, 7768, 0, -90, 0, 0x00000000, bhvBreakableBoxSmall),
		...
		OBJECT(MODEL_RED_COIN, -5131, 6371, 6837, 0, -90, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_WOODEN_SIGNPOST, -7770, 4947, 7768, 0, 132, 0, (DIALOG_010 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 1391, 5290, 7115, 0, -12, 0, (DIALOG_008 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, -7802, 4947, 6011, 0, 48, 0, (DIALOG_009 << 16), bhvMessagePanel),
