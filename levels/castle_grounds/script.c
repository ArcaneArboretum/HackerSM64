...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		WARP_NODE(0x2B, LEVEL_WF, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_1UP, 2049, -4305, -604, 0, 0, 0, 0x00000000, bhv1Up),
		...
		OBJECT(MODEL_NONE, 815, 3711, -4387, 0, 41, 0, (0x2B << 16), bhvWarpPipe),
