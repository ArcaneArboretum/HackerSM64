...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, (COIN_FORMATION_BP_SHAPE_HORIZONTAL_RING << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, 818, 163, -499, 0, 0, 0, (COIN_FORMATION_BP_SHAPE_HORIZONTAL_LINE << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, 839, 167, 477, 0, -180, 0, (COIN_FORMATION_BP_SHAPE_HORIZONTAL_LINE << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -809, -6, -408, 0, 0, 0, (COIN_FORMATION_BP_SHAPE_HORIZONTAL_LINE << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -809, -6, 414, 0, -180, 0, (COIN_FORMATION_BP_SHAPE_HORIZONTAL_LINE << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -291, 2, 825, 0, 90, 0, (COIN_FORMATION_BP_SHAPE_HORIZONTAL_LINE << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -287, -2, -828, 0, 90, 0, (COIN_FORMATION_BP_SHAPE_HORIZONTAL_LINE << 16), bhvCoinFormation),
		MARIO_POS(0x01, 90, 0, 77, 0),
		OBJECT(MODEL_WOODEN_SIGNPOST, 718, 0, -167, 0, -90, 0, (DIALOG_033 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, 718, 0, 126, 0, -90, 0, (DIALOG_034 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, -824, 0, 1, 0, 90, 0, (DIALOG_035 << 16), bhvMessagePanel),
		OBJECT(MODEL_NONE, 0, 77, 0, 0, 90, 0, 0x000A0000, bhvSpinAirborneWarp),
